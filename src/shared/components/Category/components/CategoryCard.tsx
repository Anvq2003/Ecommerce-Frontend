...
export default function CategoryCard({ category }: ICategoryCardProps) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="flex cursor-pointer items-center rounded-[10px] bg-bgSecondary p-5 lg:rounded-2xl"
    >
      ...
      <div className="flex-1">
        <h3 className="mb-2 line-clamp-2 text-lg font-bold text-primary lg:text-[22px]">
          {category?.title}
        </h3>
