...
export default function ProductInfo({ dict }: IProductInfoProps) {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-[#171C28] rounded-[10px] md:flex-row">
      {/* Box left */}
      ...
      {/* Box right */}
      <div className="mb-5 flex w-full flex-col gap-main rounded-sm sm:mb-0 md:p-5 lg:p-8 xl:w-7/12 xl:p-[60px]">
